...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* app will shrink to accommodate the phone's keyboard popping up using the following parent component */}
      <KeyboardAvoidingView
...
const styles = StyleSheet.create({
  ...
  writeTaskWrapper: {
    // allows us with position absolute to place this item anywhere on the screen UI
    position: "absolute",
    bottom: 60,
    width: "100%",
    flexDirection: "row",
